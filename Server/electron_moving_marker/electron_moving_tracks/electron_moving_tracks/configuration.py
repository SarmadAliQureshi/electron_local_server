...
select geom from {1} where file_dir_name='{0}'
...
duration_query = """select (max(datetime)-min(datetime)) as duration from {1} where file_dir_name='{0}'"""

bearing = """select viewing_direction as bearing from {1} where file_dir_name='{0}' order by datetime"""

datetime =  """select extract(epoch from datetime)  as datetime from {1} where file_dir_name='{0}' order by datetime"""